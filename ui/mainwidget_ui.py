...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_Normal = QtWidgets.QTextEdit(self.widget_3)
        self.textEdit_Normal.setStatusTip("")
        self.textEdit_Normal.setWhatsThis("")
        self.textEdit_Normal.setAccessibleDescription("")
        self.textEdit_Normal.setObjectName("textEdit_Normal")
        self.verticalLayout.addWidget(self.textEdit_Normal)
        self.textEdit_RE = QtWidgets.QTextEdit(self.widget_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "过滤方案:"))
        self.comboBox.setCurrentText(_translate("MainWindow", "初始方案"))
        self.textEdit_Normal.setToolTip(_translate("MainWindow", "正常的过滤字段"))
        self.textEdit_Normal.setPlaceholderText(_translate("MainWindow", "关键字过滤规则，每一行代表一种关键字过滤"))
        self.textEdit_RE.setPlaceholderText(_translate("MainWindow", "使用python的正则匹配过滤规则，每一行代表一种过滤"))
